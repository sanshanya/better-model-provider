 ...
 */
import type { LlmConfigurableProvider, LlmDiscoveredModel, LlmModelDiscoveryRequest, RemoteFailure, RemoteResult, RpcId, RpcResponse, RpcResult, SettingsDescribeValue, SettingsNamespaceView, SettingsPathOpView } from '@deepseek-ai/dsh-api-remotes/client';
export type { LlmConfigurableProvider, LlmDiscoveredModel, LlmModelDiscoveryRequest, RemoteFailure, RemoteResult, RpcId, RpcResponse, RpcResult, SettingsDescribeValue, SettingsNamespaceView, SettingsPathOpView, };
/**
 ...
 * to begin with.
 */
export type WireJson = Extract<SettingsPathOpView, {
    op: 'set';
}>['value'];
/**
 ...
 */
export type WireFailure = Extract<RpcResult<unknown>, {
    readonly ok: false;
}>['error'];
/**
...
export interface LlmRemoteApi {
    providers(payload: Record<string, never>, signal?: AbortSignal): Promise<RpcResponse<{
        providers: LlmConfigurableProvider[];
    }>>;
    discoverModels(payload: DiscoverPayload, signal?: AbortSignal): Promise<RpcResponse<{
