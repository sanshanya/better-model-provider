...
export type { ConfigurableProviderView, DiscoveredModelView, RpcError, RpcId, RpcResponse, SettingsNamespaceView, SettingsPathOpView } from '@deepseek-ai/dsh-api-remotes/client';
/**
...
export declare class HarnessRpcError extends Error {
    ...
    constructor(
    /** The wire-level error code — the closed upstream union, never a free string. */
    code: RpcError['code'], message: string, 
    /** The wire-level details payload — required per upstream error arm. */
