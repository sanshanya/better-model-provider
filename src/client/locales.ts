...
export const en = {
  ...
  empty: 'No declared routes yet',
  emptyHint:
    'Declare a provider with its own model list on the official Models page; '
    + 'those models appear here for capability declaration.',
...
export const zh: Record<CapsKey, string> = {
  ...
  empty: '暂无手工声明的路由',
  emptyHint: '请先在官方「模型」页手工声明提供方及其模型列表；这些模型会出现在这里，供你声明能力。',
  declaredRoute: '手工声明',
